...
config = {
    ...
    (
        ...
        {
            "filename" : "_datasets/netflix/netflix.csv",
            "value_name" : "rating",
            "timestamp_name" : "timestamp",
            "min_value_to_keep" : 4.,
            "user_min_support" : 5,
    ...
    (
        ...
        {
            "raw_data" : """pd.read_csv("_datasets/msd/msd_train_triplets.tsv", sep="\t", header=None)""",
            "user_id_name":0,
            "item_id_name":1,
            "value_name" : 2,
            "user_min_support" : 20,
    ...
    (
        Dataset("Amazon"),
        {
            "raw_data" : """pd.read_feather("_datasets/amazon/rating_all.feather")""",
            "value_name" : "rating",
            "timestamp_name" : "timestamp",
            "min_value_to_keep" : 4.,
            "user_min_support" : 5,
    ...
    (
        ...
        {
            "raw_data" : """pd.read_feather("_datasets/amazon/books/interactions_pu20_pi20.feather")""",
            "value_name" : "value",
            "timestamp_name" : "timestamp",
            "min_value_to_keep" : 1.,
            "user_min_support" : 20,
