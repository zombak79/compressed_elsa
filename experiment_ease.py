...
parser.add_argument("--nnz", default=0, type=int, help="0=full ease")
...
from layers import CompressedSparseLayerELSA
...
if __name__ == "__main__":
    ...
    if args.nnz>0:
        # sparsify weights of ease
        B=model.B
        W = CompressedSparseLayerELSA.topk_mask(torch.from_numpy(model.B), args.nnz)
        model.B=W.numpy()
