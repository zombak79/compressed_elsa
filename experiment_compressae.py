...
from compressae import CompresSAE, train, make_loaders
...
if __name__ == "__main__":
    ...
    model, info = train(
        ...
        epochs=args.epochs, lr=args.lr, weight_decay=args.weight_decay, grad_clip=None, early_stopping=100, annealing=args.vals
    )
